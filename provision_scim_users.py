...
ENTERPRISE = os.environ.get("GITHUB_ENTERPRISE")  # Read enterprise from environment variable
TOKEN = os.environ.get("GITHUB_TOKEN")  # Read token from environment variable

if not ENTERPRISE:
    raise ValueError("Please set the GITHUB_ENTERPRISE environment variable.")
if not TOKEN:
